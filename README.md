...
This crate requires the C++ PyTorch library (libtorch) in version *v2.9.1* to be available on
...
```bash
git clone -b v2.9.1 --recurse-submodule https://github.com/pytorch/pytorch.git pytorch-static --depth 1
cd pytorch-static
